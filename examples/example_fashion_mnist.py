...
from kan.quick_train.mnist import mnist
...
train_images, train_labels, test_images, test_labels = map(mx.array, getattr(mnist, "fashion_mnist")())  # Convert dataset to mlx arrays
